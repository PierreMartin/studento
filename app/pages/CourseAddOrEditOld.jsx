...
class CourseAddOrEditOld extends Component {
	constructor(props) {
		super(props);
...
export default connect(mapStateToProps, { fetchCategoriesAction, createCourseAction, updateCourseAction })(CourseAddOrEditOld);
