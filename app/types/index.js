...
// DISPLAYING MISSING FIELDS :
export const UPDATE_MISSING_REQUIRED_FIELDS = 'UPDATE_MISSING_REQUIRED_FIELDS';

// AVATARS :
export const AVATAR_UPLOAD_MODAL_ISOPEN_ACTION = 'AVATAR_UPLOAD_MODAL_ISOPEN_ACTION';
export const AVATAR_UPLOAD_IMAGEPREVIEW_ACTION = 'AVATAR_UPLOAD_IMAGEPREVIEW_ACTION';

// AVATARS REQUEST :
export const AVATAR_UPDATE_USER_SUCCESS = 'AVATAR_UPDATE_USER_SUCCESS';
export const AVATAR_UPDATE_USER_FAILURE = 'AVATAR_UPDATE_USER_FAILURE';

// AVATAR SET DEFAULT :
export const AVATAR_MAIN_SELECTED_SUCCESS = 'AVATAR_MAIN_SELECTED_SUCCESS';
export const AVATAR_MAIN_SELECTED_FAILURE = 'AVATAR_MAIN_SELECTED_FAILURE';
